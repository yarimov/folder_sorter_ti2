...
предупреждения о некорректности ссылок.
Если отчет проверки содержит статусы [None], необходимо проверить файлы проекта при необходимости провести повторную
проверку. 

Второй этап работы программы - "Сортировка". Для ее выполнения необходимо указать путь сохранения отсортированных
файлов.
...
Дополнительные настройки по сортировке будут описаны в разделе настройка config-файла.
...
"DEFAULT_FOLDER": 'C:\Users\Alex\Documents\programming\folder_sorter\test_dir\AKU.0179.30UQR.CYB.SS.TB0001'
```
